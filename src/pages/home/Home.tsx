    ...
    <div className="home-comp">
      <Row gutter={[48, 48]}>
        <Col xs={24} sm={24} md={16} lg={16} xl={16}>
          ...
          <Row justify="center" align="middle" className="user_photo_upload">
            {renderUserPhotoUpload()}
          </Row>
        </Col>

        <Col xs={24} sm={24} md={8} lg={8} xl={8}>
          <Row className="user_names">{renderUserNames()}</Row>
          <Row className="about_user">{renderAboutUser()}</Row>
          <Row className="user_info">{renderUserInfo()}</Row>
          <Row className="user_interests">{renderUserInterests()}</Row>
        </Col>
      </Row>
    </div>
  );
